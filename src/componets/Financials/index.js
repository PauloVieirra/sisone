...
export default function Financials() {
 ...
 return (
  <SafeAreaView style={styles('container')}>
       ...
       <Text style={{color:"#fff", fontSize:20, fontWeight:'bold', marginTop:8}}>Modulo indisponivel</Text>
       ...
       <Text style={{color:"#fff", fontSize:14, fontWeight:'bold'}}>-/-:</Text>
          <View style={{width:100,height:100,position:'absolute', right:5, backgroundColor:'#000:rgba(0,0,0,0.1)',alignItems:"center", justifyContent:"center"}}>
            <Text style={{color:'#fff:rgba(255,255,255,0.6)', fontSize:50, fontStyle:'normal', fontWeight:2}}>-/-</Text>
            <Text style={{color:"#fff", fontSize:14, fontWeight:'bold'}}>-/-:</Text>
          </View>
      </View>
